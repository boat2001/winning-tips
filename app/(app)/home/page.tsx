...
import { Target, BarChart3, Bookmark, ChevronRight } from "lucide-react";
...
export default async function HomePage() {
  ...
  return <div className="home-page page-stack">
    ...
    {purchases.length ? <Panel as="section" id="my-vip-games" className="scroll-mt-24 p-4 sm:p-5"><SectionHead title="Your VIP slips" action={{ label: "Browse VIP", href: "/vip" }} />
