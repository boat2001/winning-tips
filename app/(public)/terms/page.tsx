...
export const metadata: Metadata = {
  ...
  description: "Terms governing your use of Smart Tips football tips, predictions and account services.",
  alternates: { canonical: "/terms" },
};

const sections = [
  ["Using Smart Tips", "Smart Tips publishes football tips, predictions and match analysis for information only. You must be at least 18 and legally permitted to use betting-related services where you live."],
...
export default function TermsPage() {
  return <ArticlePage kicker="Legal" title="Terms of service" updated="14 August 2026" sections={sections} />;
}
