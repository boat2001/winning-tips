...
export const metadata: Metadata = {
  ...
  description: "How Winning Tips collects, uses and protects account and service data.",
...
const sections = [
  ...
  ["How we use information", "Account data authenticates you, powers member features, protects the service, lets us answer support requests and helps us improve Winning Tips. We do not use it for anything else."],
...
export default function PrivacyPage() {
  return <ArticlePage kicker="Legal" title="Privacy policy" updated={legalDocuments.privacy.updated} sections={sections} />;
}
